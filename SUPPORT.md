...
This repository supports the Packer framework itself, the repository automation around it, and the developer workflow needed to work on it safely and consistently. This includes the variable contract, normalization layer, build pipeline, and shipped example inputs.
...
- Debugging first-boot issues caused by custom user-data template modifications.
...
- the target AWS region and source AMI (ID or filter)
